    ...
    private func loadData() {
        ...
        do {
            ...
            for line in lines.dropFirst() { // Skip header
                ...
                if parts.count >= 4 && parts[1].trimmingCharacters(in: .whitespaces) == "Tap" {
...
// MARK: - Preview
struct TapGraphView_Previews: PreviewProvider {
