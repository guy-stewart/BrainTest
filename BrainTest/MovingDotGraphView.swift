...
// MARK: - Moving Dot Graph View
struct MovingDotGraphView: View {
    ...
    private func loadData() {
        ...
        do {
            ...
            for line in lines.dropFirst() { // Skip header
                ...
                if parts.count >= 4 && parts[1].trimmingCharacters(in: .whitespaces) == "Dot" {
...
// MARK: - Preview
struct MovingDotGraphView_Previews: PreviewProvider {
